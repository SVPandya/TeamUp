...
## MySQL Set Up
Go to [localhost/phpmyadmin](locahost/phpmyadmin) and create a database called `newteamup`. Inside this database, create 3 tables: `users`, `requests`, `attendances`. The `users` table should have 6 columns: Id (Auto-incrementing, primary), Username (varchar(200)), Email (varchar(200)), Age (int(11)), Password (varchar(200)), Phone_Num (int(11)). 
